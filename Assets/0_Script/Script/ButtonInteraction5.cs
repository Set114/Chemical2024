...
public class ButtonInteraction5 : MonoBehaviour
{
    ...
    {
        string O2String = n2Text.text.Trim();
        string H2String = o2Text.text.Trim();
        string CString = x2Text.text.Trim();  // 获取 X2 的文本值

        if (CString.Equals("3") && H2String.Equals("8") && O2String.Equals("2"))  // 更新条件
        {
            ShowNO2Object();
            ShowCO2Object();
            HideHintPlane();
    ...
    void HideCollidedGasObjects()
    {
        ...
        GameObject latestH2 = FindLatestGasObject(gasObjects, "H2");
        ...
        {
            if (obj != latestc && obj != latestO2 && obj != latestH2)
            {
