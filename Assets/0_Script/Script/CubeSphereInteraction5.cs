...
public class CubeSphereInteraction5 : MonoBehaviour
{
    ...
    private void UpdateTexts()
    {
        ...
        int count1 = CountcSpheres(); // 计算N2(sphere)的数量
        int count2 = CountH2Spheres(); // 计算O2(sphere)的数量
        int count3 = CountO2Spheres(); // 计算C(sphere)的数量
